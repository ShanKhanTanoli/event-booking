...
namespace App\Http\Livewire\Admin\Dashboard\Business\Mails\Send;
...
class Index extends Component
{
    ...
    {
        return view('livewire.admin.dashboard.business.mails.send.index')
    ...
    public function SendMail()
    {
        ...
        try {
            ...
            return redirect(route('AdminSendBusinessMail', ['slug' => $this->user->slug, 'lang' => App::getLocale()]));
        } catch (Exception $e) {
