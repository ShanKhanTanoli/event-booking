        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    ...
                    @if (!Auth::user())
                        <li class="nav-item">
                            <a class="nav-link me-lg-3" href="{{ route('login') }}">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link me-lg-3" href="{{ route('register') }}">Register</a>
                        </li>
                    @endif
                </ul>
                @if (Auth::user())
                ...
                <a href="{{ User::RedirectToDashboard() }}" class="btn btn-primary rounded-pill px-3 mb-2 mb-lg-0">
                    <span class="d-flex align-items-center">
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        <h1 class="display-1 lh-1 mb-3">Welcome to {{ config('app.name', 'Laravel') }}</h1>
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge"
                                    src="{{ asset('landingpage/assets/img/google-play-badge.svg') }}" alt="..." />
                            </a>
                            <a href="#!">
                                <img class="app-badge"
                                    src="{{ asset('landingpage/assets/img/app-store-badge.svg') }}" alt="..." />
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait"
                                ...
                                <div class="screen bg-black">
                                    ...
                                    <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%">
                                        <source src="{{ asset('landingpage/assets/img/demo-screen.mp4') }}"
                                            type="video/mp4" />
                                    </video>
                                </div>
                            </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="{{ asset('landingpage/assets/img/tnw-logo.svg') }}" alt="..." style="height: 3rem" />
                </div>
            </div>
        </div>
    </aside>
        ...
        <div class="container px-5">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center">
                <a class="me-lg-3 mb-4 mb-lg-0" href="#!">
                    <img class="app-badge" src="{{ asset('landingpage/assets/img/google-play-badge.svg') }}"
                        alt="..." />
                </a>
                <a href="#!">
                    <img class="app-badge" src="{{ asset('landingpage/assets/img/app-store-badge.svg') }}"
                        alt="..." />
                </a>
            </div>
        </div>
