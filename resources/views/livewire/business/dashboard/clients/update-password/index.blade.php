                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group input-group-static my-3">
                                                <label
                                                    for="password">{{ trans('business.client-new-password') }}</label>
                                                <input type="password" wire:model.defer='password'
                                                    value="{{ old('password') }}"
                                                    class="form-control  @error('password') is-invalid @enderror"
                                                    placeholder="{{ trans('business.client-new-password') }}">
                                                @error('password')
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group input-group-static my-3">
                                                <label
                                                    for="password_confirmation">{{ trans('business.client-confirm-password') }}</label>
