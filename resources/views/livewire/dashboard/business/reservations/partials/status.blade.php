            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-primary text-gray-800">
                            {{ number_format(Business::CountActiveReservations(Auth::user()->id)) }}
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-primary text-gray-800">
                            {{ number_format(Business::CountArchivedReservations(Auth::user()->id)) }}
                        </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-primary text-gray-800">
                            {{ number_format(Business::CountBannedReservations(Auth::user()->id)) }}
                        </div>
                    </div>
                    <div class="col-auto">
