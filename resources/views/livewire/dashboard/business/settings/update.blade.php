                                    ...
                                    <div class="col-12 col-sm-auto mb-3">
                                        <div class="mx-auto" style="width: 140px;">
                                            <div id="logo"
                                                ...
                                                @if(!Business::Settings(Auth::user()->id))
                                                <span style="color: rgb(166, 168, 170); font: bold 8pt Arial;">140x140</span>
                                                @else

                                                @if($logo)
                                                <img style="width:100%;" src="{{ asset($logo->temporaryUrl())}}" alt="Logo">
                                                @else

                                                @if(!is_null($logo = Business::Settings(Auth::user()->id)->logo))
                                                <img style="width:100%;" src="{{ asset('dashboard/images/business/logos/'.$logo)}}" alt="Logo">
                                                @else
                                                <span style="color: rgb(166, 168, 170); font: bold 8pt Arial;">140x140</span>
                                                @endif
                                        ...
                                        <div class="text-center text-sm-left mb-2 mb-sm-0">
                                            <div class="mt-1">
                                                ...
                                                <!-- File Input -->
                                                <input style="display:none;" wire:model.defer="logo" id="uploadlogo" type="file">
                                                <!-- Progress Bar -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <label>Text Logo (It will be used as your logo If you will not upload logo)</label>
                                                                <input wire:model.defer="text_logo"
                                                                    class="form-control @error('text_logo') is-invalid @enderror"
                                                                    id="text_logo " type="text" placeholder="e.g Your Brand Name"
                                                                    value="{{ old('text_logo') }}">
                                                                @error('text_logo')
