                                        ...
                                        <div class="row">
                                            <div class="col-12 col-sm-auto mb-3">
                                                <div class="mx-auto" style="width: 140px;">
                                                    <div class="d-flex justify-content-center align-items-center rounded"
                                                        ...
                                                        @if (!is_null($business->avatar))
                                                            <img style="width:100%;"
                                                                src="{{ asset('dashboard/images/business/avatar/' . $business->avatar) }}"
                                                                alt="Logo">
                                                        @else
                                                            <span
                                            ...
                                            <div
                                                ...
                                                <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                    <h4 class="pt-sm-2 pb-1 mb-0 text-nowrap">{!! $business->name !!}
                                                    </h4>
                                                    <p class="mb-0">
