<div class="container-fluid">
    ...
    <div class="row flex-lg-nowrap">
        ...
        @include('livewire.dashboard.admin.business.partials.create-subscription')
        <!--Begin::Subscription Modal-->
                                                    ...
                                                    @if ($subscriptions->count() > 0)
                                                        @foreach ($subscriptions as $subscription)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    @if ($business->planSubscription($subscription->invoice)->active())
                                                                        @if (!$business->planSubscription($subscription->invoice)->canceled())
                                                                            <span class="badge badge-primary">
                                                                    ...
                                                                    @endif
                                                                    @if ($business->planSubscription($subscription->invoice)->canceled())
                                                                        @if (!$business->planSubscription($subscription->invoice)->ended())
                                                                    ...
                                                                    @endif
                                                                    @if ($business->planSubscription($subscription->invoice)->onTrial())
                                                                        <span class="badge badge-danger">
