                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <div class="custom-controls-stacked">
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_create_reservation"
                                                                        type="checkbox"
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_update_reservation"
                                                                        type="checkbox"
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_delete_reservation"
                                                                        type="checkbox"
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="custom-controls-stacked">
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_view_client"
                                                                        type="checkbox"
                                                                        class="custom-control-input  @error('can_view_client') is-invalid @enderror"
                                                                        id="can_view_client" @if (Admin::BusinessCanViewClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_view_client">
                                                                        Can View Clients
                                                                    </label>
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_create_client"
                                                                        ...
                                                                        id="can_create_client" @if (Admin::BusinessCanCreateClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_create_client">
                                                                        Can Create Clients
                                                                    </label>
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_update_client"
                                                                        ...
                                                                        id="can_update_client" @if (Admin::BusinessCanUpdateClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_update_client">
                                                                        Can Update Clients
                                                                    </label>
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_delete_client"
                                                                        ...
                                                                        id="can_delete_client" @if (Admin::BusinessCanDeleteClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_delete_client">
                                                                        Can Delete Clients
                                                                    </label>
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_verify_client"
                                                                        ...
                                                                        id="can_verify_client" @if (Admin::BusinessCanVerifyClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_verify_client">
                                                                        Can Verify Clients
                                                                    </label>
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_add_client"
                                                                        type="checkbox"
                                                                        class="custom-control-input @error('can_add_client') is-invalid @enderror"
                                                                        id="can_add_client" @if (Admin::BusinessCanAddClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_add_client">
                                                                        Can Add Clients
                                                                    </label>
                                                                    @error('can_add_client')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input wire:model.defer="state.can_remove_client"
                                                                        type="checkbox"
                                                                        class="custom-control-input @error('can_remove_client') is-invalid @enderror"
                                                                        id="can_remove_client"
                                                                        @if (Admin::BusinessCanRemoveClients($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_remove_client">
                                                                        Can Remove Clients
                                                                    </label>
                                                                    @error('can_remove_client')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <div class="custom-controls-stacked">
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_view_pricing_plan"
                                                                        type="checkbox"
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_create_pricing_plan"
                                                                        type="checkbox"
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_update_pricing_plan"
                                                                        type="checkbox"
                                                                ...
                                                                <div class="custom-control custom-checkbox mt-4">
                                                                    <input
                                                                        wire:model.defer="state.can_delete_pricing_plan"
                                                                        type="checkbox"
                                                                        class="custom-control-input @error('can_delete_pricing_plan') is-invalid @enderror"
                                                                        id="can_delete_pricing_plan"
                                                                        @if (Admin::BusinessCanDeletePricingPlans($business->id)) checked="checked" @endif>
                                                                    <label class="custom-control-label"
                                                                        for="can_delete_pricing_plan">
                                                                        Can Delete Pricing Plans
                                                                    </label>
                                                                    @error('can_delete_pricing_plan')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    @enderror
