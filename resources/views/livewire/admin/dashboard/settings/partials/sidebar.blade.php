<div class="col-lg-3">
    <div class="card position-sticky">
        <ul class="nav flex-column bg-white border-radius-lg p-3">
            <li wire:ignore.self
                class="nav-item @if (Request::path() == 'Admin/Settings/General') active bg-gradient-primary @else @endif">
                <a wire:ignore.self
            ...
            <li wire:ignore.self
                class="nav-item @if (Request::path() == 'Admin/Settings/Currency') active bg-gradient-primary @else @endif">
                <a wire:ignore.self
            ...
            <li wire:ignore.self
                class="nav-item @if (Request::path() == 'Admin/Settings/Stripe') active bg-gradient-primary @else @endif">
                <a wire:ignore.self
